...
const Shuffle = ({
  ...
  useEffect(() => {
    if ('fonts' in document) {
      // document.fonts.ready resolves immediately if already loaded,
      // so the setState always runs asynchronously (never synchronously in the effect body)
      document.fonts.ready.then(() => setFontsLoaded(true));
    } else {
      // Defer to next tick so it's never a synchronous setState inside the effect
